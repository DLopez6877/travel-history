...
///////////               BACK_END                ///////////
/////////////////////////////////////////////////////////////
function Place(name, photo, date, activities) {
  this.placeName = name;
...
$(function() {
  $("form#new-destination").submit(function(event){
    ...
    var newPlacePhoto = $("input#photo-destination").val();
    ...
    var newPlace = new Place(newPlaceName, newPlacePhoto, newPlaceDate, newPlaceActivities);
    ...
    $(".user-result").last().click(function() {
      ...
      $(".result-photo").after("<img src='" + newPlace.placePhoto + "'/>")
